...
public class ReturnWorngQRActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_worng_qractivity);
                    ...
                    call.enqueue(new Callback<PostStation>() {
                        ...
                        public void onResponse(Call<PostStation> call, Response<PostStation> response) {
                            if(response.isSuccessful()){
                                Intent intent = new Intent(ReturnWorngQRActivity.this, MainActivity.class);
